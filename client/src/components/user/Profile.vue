            ...
            <div class="modal-content shadow-lg border-0 rounded-4">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control rounded-3" value="dn1fu">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" class="form-control rounded-3" value="toiyeufigma@gmail.com">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Số điện thoại</label>
                        <input type="tel" class="form-control rounded-3" value="+84 989898989">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Địa chỉ</label>
                        <input type="text" class="form-control rounded-3" placeholder="Nhập địa chỉ">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Bio</label>
                        <textarea class="form-control rounded-3" rows="3">Kể cho chúng tôi về bạn...</textarea>
                    </div>
                    </form>
                </div>
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="button" class="btn btn-primary rounded-3 px-4">Lưu thay đổi</button>
                </div>
            </div>
        </div>
    </div>
